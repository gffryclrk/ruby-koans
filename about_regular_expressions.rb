...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # There's two ways to look at it: it will never fail with a single character because it will always return an empty string.
    # However, if there's two characters that don't fit before and after it can fail. For example, "azc"[/ab*c/] will fail
    # since b* does not match z and ac doesn't match az or zc. http://stackoverflow.com/q/5084141/4203503
  end
  ...
  # They are greedy because they match as much as they can. 
  ...
  # Well, the alternation is sort of or. It can be this OR this OR this.
  # The character class defines things that are perhaps more than one character,
  # for when you want to match specific groups of patterns. 
