...
class AboutClassMethods < Neo::Koan
  ...
  # I probably prefer class << self but only because I've seen it more and am more familiar with it.
  # I like def self.method also, and am not sure about any benefits to either. 
  # ------------------------------------------------------------------
