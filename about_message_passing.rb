...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # I looked this up on StackOverflow and am still a bit puzzled by it.
    # I suppose it has to do with __send__ not being overwritten (or it shouldn't be).
    # so __send__ is always the default behaviour and is generally left alone is what I'm understanding.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # I guess it depends on what you redefine method_missing to do. Instead of raising an 
    # error you could get it to behave anyway you wanted, I suppose. 
    #
    # NOTE:
    #
